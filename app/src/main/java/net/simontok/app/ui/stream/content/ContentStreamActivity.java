...
public class ContentStreamActivity extends BaseActivity implements ContentStreamView, HlsSampleSource.EventListener, View.OnClickListener {

    @Inject
    ContentStreamMvpPresenter<ContentStreamView> presenter;
    ...
    private String video_url, video_type, video_title, video_backdrop;
    ...
    private Runnable updatePlayer,hideControls, showRegisterDialog;
    ...
    private void loadRemoteMedia(int position, boolean autoPlay) {
        ...
        remoteMediaClient.addListener(new RemoteMediaClient.Listener() {
            ...
            public void onStatusUpdated() {
                Intent intent = new Intent(ContentStreamActivity.this, ExpandedControlsActivity.class);
...
//        video_url = new String[]{"https://byteart.github.io/resource/play.mp4","https://byteart.github.io/resource/play.mp4"};
//        video_title = new String[]{"Big Buck Bunny","Movie Trailer"};

               video_type = "others";
               video_url = movie.getUr();
...
//        }
        ...
        if(player!=null) {
            ...
            loadingPanel.setVisibility(View.VISIBLE);
            mainHandler.postDelayed(updatePlayer, 200);
            mainHandler.postDelayed(hideControls, 10000);
            mainHandler.postDelayed(showRegisterDialog, 15000);
            controlsState = ControlsMode.FULLCONTORLS;
        }
    }
