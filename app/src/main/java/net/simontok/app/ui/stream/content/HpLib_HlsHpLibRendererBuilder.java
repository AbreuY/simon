...
class HpLib_HlsHpLibRendererBuilder implements HpLib_RendererBuilder {
    ...
    public HpLib_HlsHpLibRendererBuilder(ContentStreamActivity player, String userAgent, String video_url) {
        this.context = player;
    ...
    private static final class AsyncRendererBuilder implements ManifestFetcher.ManifestCallback<HlsPlaylist> {
        ...
        private final String userAgent;
        private final String url;
        private final ContentStreamActivity player;
        private final ManifestFetcher<HlsPlaylist> playlistFetcher;
        private boolean canceled;
        public AsyncRendererBuilder(Context context, String userAgent, String url, ContentStreamActivity player) {
        ...
        public void onSingleManifest(HlsPlaylist manifest) {
            ...
            HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
                    MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, ContentStreamActivity.TYPE_VIDEO);
