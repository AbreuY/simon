...
package net.simontok.app.service;
...
import net.simontok.app.di.component.ServiceComponent;
import net.simontok.app.utils.AppLogger;

import net.simontok.app.SiMontok;
import net.simontok.app.di.component.DaggerServiceComponent;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        ...
        ServiceComponent component = DaggerServiceComponent.builder()
                .applicationComponent(((SiMontok) getApplication()).getComponent())
                .build();
