...
public class MovAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MovAdapter(Context context, List<MovieResponse> movies) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_MOVIE) {
            return new MovieHolder(inflater.inflate(com.gokep.app.R.layout.item_movie_backdrop, parent, false));
        } else {
    ...
    public static class MovieHolder extends RecyclerView.ViewHolder {
        ...
        public MovieHolder(View itemView) {
            ...
            imgContent = (ImageView) itemView.findViewById(com.gokep.app.R.id.img_content);
            txtTitle = (TextView) itemView.findViewById(com.gokep.app.R.id.txt_title);
            txtTime = (TextView) itemView.findViewById(com.gokep.app.R.id.txt_time);
        }

        void bindData(MovieResponse movie) {
            if (movie.getImgs() != null) {
                if (!movie.getImgs().contains("http")) {
