...
import com.gokep.app.di.component.DaggerActivityComponent;
...
public abstract class BaseActivity extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((GoKEP) getApplication()).getComponent())
                .build();
    ...
    private void showSnackBar(String message) {
        ...
        textView.setTextColor(ContextCompat.getColor(this, com.gokep.app.R.color.white));
        snackbar.show();
    }
    ...
    public void onError(String message) {
        if (message != null) {
            ...
            showSnackBar(getString(com.gokep.app.R.string.some_error));
        }
    }
    ...
    public void showMessage(String message) {
        if (message != null) {
            ...
            Toast.makeText(this, getString(com.gokep.app.R.string.some_error), Toast.LENGTH_SHORT).show();
        }
    }
