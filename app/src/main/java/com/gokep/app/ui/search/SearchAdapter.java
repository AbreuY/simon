...
public class SearchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SearchAdapter(Context context, List<MovieResponse> movies) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if(viewType==TYPE_MOVIE){
            ...
            return new AdsHolder(inflater.inflate(R.layout.item_ads, parent, false));
        } else {
...
//            AdsHolder adsHolder = (AdsHolder) holder;
    ...
    public static class MovieHolder extends RecyclerView.ViewHolder{
        ...
        public MovieHolder(View itemView) {
            ...
            imgThreeDot = (ImageView) itemView.findViewById(R.id.add_watch_later);
            imgContainer = (RelativeLayout) itemView.findViewById(R.id.img_container);
        }
